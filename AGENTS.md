...
This project is indexed by GitNexus as **praxis** (702 symbols, 1127 relationships, 26 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
